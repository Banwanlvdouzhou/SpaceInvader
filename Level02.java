...
public class Level02 {
    ...
    public Hero hero = new Hero(550,800,15,3,3);
    ...
    public void levelMap02(){
        for (int i = 0; i < 4; i++) {//可以写的更好看点
            Barrier barrier1 = new Barrier(110+180*i,780);
            Barrier barrier2 = new Barrier(130+180*i, 780);
            Barrier barrier3 = new Barrier(150+180*i, 780);
            Barrier barrier4 = new Barrier(190+180*i, 780);
            Barrier barrier5 = new Barrier(210+180*i, 780);
            Barrier barrier6 = new Barrier(230+180*i, 780);

            Barrier barrier7 = new Barrier(110+180*i,760);
            Barrier barrier8 = new Barrier(130+180*i, 760);
            Barrier barrier9 = new Barrier(150+180*i, 760);
            Barrier barrier10 = new Barrier(190+180*i, 760);
            Barrier barrier11 = new Barrier(210+180*i, 760);
            Barrier barrier12 = new Barrier(230+180*i, 760);

            Barrier barrier13 = new Barrier(130+180*i, 740);
            Barrier barrier14 = new Barrier(150+180*i, 740);

            Barrier barrier15 = new Barrier(190+180*i, 740);
            Barrier barrier16 = new Barrier(210+180*i, 740);

            Barrier barrier17 = new Barrier(150+180*i, 720);
            Barrier barrier18 = new Barrier(170+180*i, 720);
            Barrier barrier19 = new Barrier(190+180*i, 720);
        ...
        for (int i = 0; i < 7; i++) {//列
            for (int j = 0;j < 3; j++) {//行
                Invaders invader = new Invaders(5*j+(100 * (i + 1)), (100 * (j + 1)), 1);
        ...
        for (int i = 0; i < 7; i++) {//列
            for (int j = 0;j < 3; j++) {//行
                BlueInvaders blueInvader = new BlueInvaders(15+5*j+(100 * (i + 1)), 150+(100 * j), 1);
